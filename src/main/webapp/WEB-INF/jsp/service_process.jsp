...
<html>
	...
	<head>
		...
		function doSearch(){
			...
			function process(){
				...
				url = "${ctx}/customerService/serviceProcess.action";
				$('#form').form('load',row);
			}
			...
			$(function(){
				$('#tableId').datagrid({
					url:"${ctx}/customerService/findNotDel.action",
					method:'get',
					fit:true,
					singleSelect:false,
					toolbar:'#toolbar',
	...
	<body>
		<table id="tableId"></table>
			...
			<div id="toolbar">
				<div>
					<a href="javascript:process();" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">处理</a>
				</div>
			</div>
	</body>
	<!-- 添加用户隐藏的div开始 -->
	<div id="dialog" class="easyui-dialog" style="width:600px;height:400px;" closed="true" buttons="#dialog-button">
    		<form id="form" action="" method="post">   
			    ...
			    <table cellpadding="5">
		    		...
		    		<tr>
		    			<td>分配人:</td>
		    			<td><input class="easyui-textbox" name="assigner" id="assignerId" 
		    			 data-options="
