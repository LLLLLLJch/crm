...
public class CustomerService {
	...
	public String toString() {
		return "CustomerService [id=" + id + ", serviceType=" + serviceType + ", overview=" + overview + ", customer="
				+ customer + ", status=" + status + ", serviceRequest=" + serviceRequest + ", createPeople="
				+ createPeople + ", createTime=" + createTime + ", assigner=" + assigner + ", assignTime=" + assignTime
				+ ", serviceDeal=" + serviceDeal + ", serviceDealPeople=" + serviceDealPeople + ", serviceDealTime="
				+ serviceDealTime + ", serviceDealResult=" + serviceDealResult + ", satisfy=" + satisfy + "]";
	}
